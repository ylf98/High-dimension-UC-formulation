...
for i=1:secondary_vari_num
    for j=0:L
        ...
        gradiant(1,i)=-0.5*model.H(secondary_vari_location(i),secondary_vari_location(i))*(j/L)^2;
        gradiant(1,secondary_vari_location(i))=model.H(secondary_vari_location(i),secondary_vari_location(i))*(j/L);
